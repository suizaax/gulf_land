      ...
      <div>
        ...
        <Paper elevation={0} id='hero section' sx={{ height: "590px" }}>
          <div className='heroVideoMobile'>
            <img src='https://firebasestorage.googleapis.com/v0/b/mamgroupsauth.appspot.com/o/Wondershare%20UniConverter%2013_000001.GIF?alt=media&token=d7928812-426d-4e13-b0a4-a7b9df8c3501' style={{ objectFit: "cover", backgroundPosition: "center" }} height="690px" width={"100%"}></img>
            {/* <video
              autoPlay
              muted
              loop
