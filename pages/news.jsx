            ...
            <div>
                ...
                <Paper elevation={0} id='hero section' sx={{ height: "500px" }}>
                    <div className='heroVideoMobile'>
                        <img src='https://res.cloudinary.com/suizaax/image/upload/v1652049045/output-onlinegiftools_1_1_mcdh6w.gif' style={{ objectFit: "cover", backgroundPosition: "center" }} height="600px" width={"100%"}></img>
                        {/* <video
                            autoPlay
                            muted
                            loop
